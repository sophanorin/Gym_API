        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "TEXT", nullable: false),
                    GenderId = table.Column<string>(type: "TEXT", nullable: false),
                    UserCredentialId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Supervisor_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Supervisor_GenderId",
                table: "Supervisor",
                column: "GenderId");

            migrationBuilder.CreateIndex(
                name: "IX_Supervisor_StatusId",
                table: "Supervisor",
                column: "StatusId");
